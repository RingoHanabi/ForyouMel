...
class wedding_type_admin(SortableAdminMixin, admin.ModelAdmin):
    list_display = ("name_cn", "name_en", "order")

class wedding_admin(SortableAdminMixin, admin.ModelAdmin):
...
admin.site.register(wedding_type, wedding_type_admin)
